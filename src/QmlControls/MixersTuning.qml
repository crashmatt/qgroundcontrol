    ...
    QGCViewPanel {
        ...
        Row {
            ...
            QGCButton {
                ...
                onClicked: {
                    controller.getMixersCountButtonClicked()
                }
            }
            ...
            QGCButton {
                ...
                onClicked: {
                    controller.requestAllButtonClicked()
                }
            }
            ...
            QGCButton {
                ...
                onClicked: {
                    controller.requestGUIButtonClicked()
                }
            }
            ...
            QGCButton {
                ...
                onClicked: {
                    controller.refreshGUIButtonClicked()
                }
            }
